...
@RenamerAdarsh.on_message(filters.photo & filters.incoming & filters.private)
...
@RenamerAdarsh.on_message(filters.command("deletethumbnail") & filters.incoming & filters.private)
...
@RenamerAdarsh.on_message(filters.command("showthumbnail") & filters.incoming & filters.private)
