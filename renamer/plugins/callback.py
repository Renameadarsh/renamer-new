...
@RenamerAdarsh.on_callback_query(filters.regex('^help$'))
...
@RenamerAdarsh.on_callback_query(filters.regex('^donate$'))
...
@RenamerAdarsh.on_callback_query(filters.regex('^close$'))
...
@RenamerAdarsh.on_callback_query(filters.regex('^back$'))
...
@RenamerAdarsh.on_callback_query(filters.regex('^about$'))
