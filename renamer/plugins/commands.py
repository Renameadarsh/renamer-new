...
@RenamerAdarsh.on_message(filters.command("help") & filters.private & filters.incoming)
...
@RenamerAdarsh.on_message(filters.command("start") & filters.private & filters.incoming)
...
@RenamerAdarsh.on_message(filters.command("about") & filters.private & filters.incoming)
...
@RenamerAdarsh.on_message(filters.command("mode") & filters.private & filters.incoming)
...
@RenamerAdarsh.on_message(filters.command("reset") & filters.private & filters.incoming)
...
@RenamerAdarsh.on_message(filters.command('Private') & filters.incoming & filters.private)
async def password(c, m):
    if Config.BOT_PASSWORD:
        if m.from_user.id in Config.AUTH_USERS:
            return await m.reply_text(f"__Hey you are a authorised user of this bot so you don't need to login {DETECTIVE_LIGHT_SKIN_TONE}.__")
